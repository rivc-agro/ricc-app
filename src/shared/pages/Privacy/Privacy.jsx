                ...
                <div className="site-container grid-container">
                    ...
                    <div className="grid-container__block">
                        <section className={styles.section}>
                            ...
                            <p>
                                We, Danit, a limited liability company duly organized under the laws of the United Arab Emirates, under the Commercial License number 2200543.01, whose registered address is at Business Center 1, M Floor, The Meydan Hotel, Nad Al Sheba, Dubai, U.A.E.  (“we”, “us”, “ours”) respect the privacy of all of our users and are committed to protecting information collected through the Website.
                                Personal information about you may be collected in several ways when you use the Website or any Services.
                                We provide this statement and our Cookies Policy (“Privacy Policy”) to help you to understand what we may do with any personal information that we obtain from you.
                                This Privacy Policy does not govern our collection or use of data about you through channels other than the Website.
                                Please exit the Website immediately if you are accessing the Website in a country or other territory where use of the Website is not permitted.
                            </p>

                            <h2>1.	What categories of Personal Information do we collect?</h2>
                            <p>
                            ...
                            <ul>
                                ...
                                <li>Your correct date of birth, which we may require that you submit accurately to ensure that you do not access the Website if you are not of a legal age to purchase products offered for sale on the Website;</li>
                                <li>Any information you may provide when you contact us or send us a correspondence;</li>
                                <li>Information necessary to process an order which is placed with us: your name, email address, phone numbers, home address, shipping and credit/debit card billing address(es);</li>
                                <li>Details of any transactions you carry out through the Website, including the placement of any orders by you: payment information (for example credit card details, or other payment details which you must provide to receive products you have ordered from us), connection data and your taste and preferences; and</li>
                                <li>Details of your visits to the Website including, but not limited to, your computer’s IP address, password information, page interaction information, traffic data, location data, weblogs, and other data about the resources that you access.</li>
                            </ul>
                            ...
                            <p>
                                We use cookies and track IP addresses so we can improve our Services and enhance your experience as detailed below.
                            </p>
                            <p>
                                Cookies are data files a website can send to your computer’s browser for record-keeping purposes. We use cookies to help us to gather and store information about visitors to our Website which helps us and to make our Website more user friendly, and to give you a better experience when you return to the Website.
                            </p>
                            <p>
                                We may use information from cookies for the following purposes:
                            </p>
                            <p>
                                Traffic monitoring, for example, the IP address from which you access the Website, the type of browser and operating system used to access the Website, the date and time of your access to the Website, the pages you visit, and the Internet address of the website from which you accessed our Website;
                            </p>
                            <ul>
                                <li>
                                ...
                                <li>
                                    To customize or personalize your experience of the Website, for example, so that we can greet you by name;
                                </li>
                                <li>
                                    For transactional purposes, such as credit/debit card sales;
                                </li>
                                <li>
                                    To monitor your use of the Website in order to make our communications with you as relevant as possible, for example, by sending you email communications relevant to the parts of the Website that you visit most often or by letting you know about features of the Website that you have not accessed previously.
                                </li>
                            </ul>

                            <p>
                                We may compile and report to third parties (such as advertisers) anonymous statistics about our users in terms of numbers, traffic patterns and related site information.
                                While functional cookies may be installed to facilitate your visit of our Website, you may express your choice regarding our cookies through the privacy settings options of your browser which should include features to prevent from storing information on the terminal or processing information already stored on such terminal, unless you turn on the feature to allow such storage or processing.
                                Each browser has its own cookie management system, you can find information specific to your browser under the “help” menu, where you will be provided with all necessary information about how to set your preferences.
                                Whereas some cookies may be functional to collect information which will allow us to facilitate your browsing such as languages preferences, memorizing log-in, or saving the content of your shopping basket, other cookies also collect information on your behaviour by saving your preferences as detailed above.
                                We cannot guarantee the proper functioning of the Website if you choose to disable your cookies. However, your visit to our Website will be significantly enhanced if cookies are not disabled.
                            </p>
                            ...
                            <p>
                                ...
                                our Personal Information will not be kept in a form that allows you to be identified for any longer than is reasonably considered necessary by us for achieving the purposes for which it was collected or processed or as it is established in the applicable laws related to data retention periods.
                            </p>
                            ...
                            <ul>
                                <li>
                                    Right of acces. You have the right to confirm with us whether your Personal Information is processed, and if it is, to request access to that Personal Information including the categories of Personal Information processed, the purpose of the processing and the recipients or categories of recipients.
                                </li>
                                <li>
                                    Right to rectification. You may have the right to rectify inaccurate or incomplete your Personal Information.
                                </li>
                                <li>
                                    Right to erasure. You may have the right to ask us to erase your Personal Information.
                                </li>
                                <li>
                                    Right to restriction of processing. In limited circumstances, you may have the right to request that we restrict processing of your Personal Information.
                                </li>
                                <li>
                                    Right to data portability.  You may have the right to receive your Personal Information, which you have provided to us, in a structured, commonly used and machine-readable format and you may have the right to transmit that data to another entity.
                                </li>
                                <li>
                                ...
                                <li>
                                    Right to provide your instructions regarding the storage, deletion or disclosure of your Personal Information after your death.
                                </li>
                            </ul>
                            ...
                            <p>
                                ...
                                This Privacy Policy is reproduced in English.
                            </p>
                        </section>
                    </div>
                </div>
